...
const Search = (props) => {
    return (
        <div className='search_wrap'>
            ...
            <input value={props.searchValue} onChange={ (event) => props.setSearchValue (event.target.value)} className='search' placeholder='Поиск...'/>
            {
              props.searchValue && <svg onClick={ () => props.setSearchValue('')} className='icon_close'  viewBox="0 0 48 48"  xmlns="http://www.w3.org/2000/svg"><path d="M38 12.83l-2.83-2.83-11.17 11.17-11.17-11.17-2.83 2.83 11.17 11.17-11.17 11.17 2.83 2.83 11.17-11.17 11.17 11.17 2.83-2.83-11.17-11.17z"/><path d="M0 0h48v48h-48z" fill="none"/></svg>
            }
